...
const CtaArrowIcon = () => (
  <svg xmlns="http://www.w3.org/2000/svg" width="40" height="40" viewBox="0 0 40 40" fill="none" className="ts-go-to-icon">
    <g clipPath="url(#cta_arrow_clip)">
      ...
      <mask id="cta_arrow_mask" style={{maskType: 'luminance'}} maskUnits="userSpaceOnUse" x="13" y="14" width="14" height="13">
        <path d="M26.2219 26.8105H13.5947V14.0974H26.2219V26.8105Z" fill="white"/>
      </mask>
      <g mask="url(#cta_arrow_mask)">
  ...
  return (
    <div className="about-page-container">
      ...
      <section className="mission-vision-section">
        <div className="mission-vision-row">
          <div className="mv-block">
            <div className="mv-icon"><Scale size={32} /></div>
            <h3>Our Mission</h3>
            <p>
      ...
      <div className="about-content-wrapper">
        <div className="about-cta-section" onClick={() => navigate('/tools')}>
